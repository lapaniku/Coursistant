...
- (void)drawInContext:(CGContextRef)context
{
    ...
    UIColor *color2 = (self.gripped) ? [UIColor colorWithWhite:0.894 alpha:1.0] : [UIColor colorWithWhite:0.996 alpha:1.0];
    NSArray *colors = [NSArray arrayWithObjects:(__bridge id)[UIColor colorWithWhite:0.82 alpha:1.0].CGColor, (__bridge id)color2.CGColor, nil];
    ...
    CGGradientRef knobGradient = gradient;
    ...
    /////
    colors = [NSArray arrayWithObjects:(__bridge id)[UIColor whiteColor].CGColor, (__bridge id) [UIColor colorWithWhite:1.0 alpha:0.5].CGColor, nil];
    gradient = CGGradientCreateWithColors(colorSpace, (__bridge CFArrayRef) colors,colorStops);
    ...
    CGGradientRef knobHighlightGradient = gradient;
    /////
...
//	CFArrayRef colorsArray = CFArrayCreate(nil, (const void**)colors, sizeof(colors) / sizeof(CGColorRef)+1, &kCFTypeArrayCallBacks);
//	CGGradientRef gradient = CGGradientCreateWithColors(colorSpace, colorsArray, colorStops);
//	CFRelease(colorsArray);
//	return gradient;

    CGFloat colorStops[2] = {0.0, 1.0};
    //UIColor *startColor1 = [UIColor colorWithRed:0.0 green:0.0 blue:0.0 alpha:1.0];
    //UIColor *endColor1 = [UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:1.0];

    //NSArray *colors = [NSArray arrayWithObjects:(__bridge id)startColor1.CGColor, (__bridge id)endColor1.CGColor, nil];
