//
//  DownloadControlBackgroundView.m
...
@implementation DownloadControlBackgroundView

#define CAP_INSET 3.0
#define CONTENT_INSET 3.0
#define ARROW_HEIGHT 17.0
#define ARROW_BASE 26.0


-(id)initWithFrame:(CGRect)frame{
    if (self = [super initWithFrame:frame]) {
        _borderImageView = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"popover-border3.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(CAP_INSET,CAP_INSET,CAP_INSET,CAP_INSET)]];
        
        _arrowView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"arrow2.png"]];
...
//        l.shadowColor = [[UIColor clearColor] CGColor];
    }
    return self;
}
